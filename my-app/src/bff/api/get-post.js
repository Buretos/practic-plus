...
export const getPost = async (postId) =>
	fetch(`http://localhost:3005/posts/${postId}`)
		.then((res) => {
			...
			// Возвращаем (прокидываем) Promise.reject, значит можем принять его и обработать в catch (наприммер в fetch-post, откуда был запрос сюда). Но там мы запрашивали через async/await. Ошибки будут обрабатываться не через then/catch, a через try/catch.
